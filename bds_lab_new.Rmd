...
Applying the `completenessByColumn` function, we find that almost  $69\%$ of NEO_APGAR_NUM column data is missing and $4.58\%$ of NEO_WEIGHT_NUM column data is also missing. These two columns overall conclude, that we have $4.88\%$ missing values in our data set, the majority being in the NEO_APGAR_NUM column. 
