...
!(sapply(DEL_MODE,tolower) %in% "emergency caesarea") | (sapply(DEL_TYPE_ANE,tolower) %in% c("epidural anesthesia / general anesthesia","spinal anesthesia","spinal anesthesia / general anesthesia","general anesthesia"))
